...
class _EmailPasswordSignInContentsState
  ...
  Future<void> _submit(EmailPasswordSignInState state) async {
    ...
    if (_formKey.currentState!.validate()) {
      final controller = ref.read(
          emailPasswordSignInScreenControllerProvider(widget.formType)
              .notifier);
  ...
  void _updateFormType(EmailPasswordSignInFormType formType) {
    ...
    ref
        .read(emailPasswordSignInScreenControllerProvider(widget.formType)
            .notifier)
  ...
  Widget build(BuildContext context) {
    ...
    final state =
        ref.watch(emailPasswordSignInScreenControllerProvider(widget.formType));
